...
if __name__ == '__main__':
    ...
    parser.add_argument('--list_file', type=str, default=osp.join(myexp_path,'info','video_list.txt'),
                        ...
                        in the form of xxxx0.mp4\nxxxx1.mp4\nxxxx2.mp4\n \
                                     or xxxx0\nxxxx1\nxxxx2\n')
    parser.add_argument('--source_video_path',type=str,default=osp.join(myexp_path,"shot_split_video"))
    parser.add_argument('--save_wav_path',    type=str,default=osp.join(myexp_path,"aud_wav"))
    parser.add_argument('--save_stft_path',   type=str,default=osp.join(myexp_path,"aud_feat"))
